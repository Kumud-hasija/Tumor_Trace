...
👉 https://www.kaggle.com/datasets/kumudhasija/classification-roi
...
4. Train the Model - **tumortrace.ipynb**
  - Clone the repository:
      ```bash
      git clone https://github.com/Kumud-hasija/Tumor_Trace.git
      cd Code
  - Upload or copy the notebook: tumortrace.ipynb (for training)
...
5.  Run Gradio Interface for Predictions - **tumortrace-application.ipynb**
   ...
   - Upload or copy the notebook: tumortrace-application.ipynb (for prediction UI)
...
To skip training, you can download pretrained models from:

👉 https://drive.google.com/drive/folders/1UQ2OBb2KQzwvhBWZtXCdoaJ3WsTxqg_d?usp=sharing
